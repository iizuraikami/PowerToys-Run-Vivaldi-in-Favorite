...
using Community.PowerToys.Run.Plugin.VivaldiFavorite.Helpers;
...
namespace Community.PowerToys.Run.Plugin.VivaldiFavorite
{
    public class Main : IPlugin, ISettingProvider, IContextMenu
    {
        ...
        public string Name => "Vivaldi Favorite";

        public string Description => "Vivaldiブラウザのブックマークを検索します";
